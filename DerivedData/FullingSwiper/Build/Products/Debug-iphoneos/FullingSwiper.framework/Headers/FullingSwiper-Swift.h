...
SWIFT_CLASS("_TtC13FullingSwiper27FullingSwiperViewController")
@interface FullingSwiperViewController : UIViewController
...
@interface FullingSwiperViewController (SWIFT_EXTENSION(FullingSwiper))
@end
...
- (FullingSwiperViewController * __nonnull)animateScale:(CGFloat)scale;
@end
...
- (FullingSwiperViewController * __nonnull)poping:(void (^ __nullable)(void))popHandler;

/// set shouldBeginGesture handler
- (FullingSwiperViewController * __nonnull)shouldBeginGesture:(void (^ __nullable)(void))shouldBeginGestureHandler;

/// set completed handler
- (FullingSwiperViewController * __nonnull)completed:(void (^ __nullable)(void))completed;
@end
